...
class YourDriver {
    /**
     * Creates three HotDogStand objects with random unique IDs, orders a random number of hot dogs between 200 and 500 for each stand, adds total sold, finds income, and prints.
     * @param args
     */
